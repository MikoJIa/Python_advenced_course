...
# Примечание. Разберём первый тест. У нас формируется список [1, 2, 3, 4, 5],
# в нём 2 > 1, 3 > 2, 4 > 3, 5 > 4. То есть получается 4 таких случая,
